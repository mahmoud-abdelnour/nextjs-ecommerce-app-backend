...
const registerCustomer = async (req, res) => {
  ...
  try {
    const { name, email, password } = req.body;//jwt.decode(token);
...
const updateCustomer = async (req, res) => {
  try {
    // Validate the input
    const { name, email, lastName, phone, image } = req.body;
    //console.log("req.body aasqqqq",req.body);
...
const updateAddress = async (req, res) => {
  ...
  try {
    // Validate the input
    const { streetAddress, email, cityAddress } = req.body;
    ...
    // Update customer details
    customer.cityAddress = cityAddress;
    ...
    res.send({
      ...
      name: updatedUser.name,
      email: updatedUser.email,
      cityAddress: updatedUser.cityAddress,
